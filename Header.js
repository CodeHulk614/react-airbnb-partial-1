    ...
    return(
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <div className="container-fluid">
                <a className="navbar-brand" href="test">TGM</a>
                ...
                <form className="d-flex" role="search">
                    <input style={{borderRadius:'20px'}} className="form-control me-4" type="search" placeholder="Search" aria-label="Search"></input>
                    <button style={{borderRadius:'20px'}} className="btn btn-outline-success" type="submit">Search</button>
                </form>
                </div>
            </div>
        </nav>
